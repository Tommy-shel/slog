...
// FIX: Register ScrollToPlugin here
...
function App() {
  ...
  return (
    <div ref={container} className="min-h-screen text-gray-800 font-sans">
      {/* Navigation */}
      <nav className="bg-gradient-to-r sticky top-0 from-purple-600 to-blue-600 text-white font-semibold rounded-3xl shadow-lg m-4 z-50">
